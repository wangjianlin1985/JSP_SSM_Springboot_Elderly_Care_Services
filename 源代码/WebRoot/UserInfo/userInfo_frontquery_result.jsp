...
<%
    ...
    String name = (String)request.getAttribute("name"); //老人姓名查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>UserInfo/frontlist">老人信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp" style="display:none;">添加老人</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<userInfoList.size();i++) {
            		...
            		UserInfo userInfo = userInfoList.get(i); //获取到老人对象
            		String clearLeft = "";
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="name" name="name" value="<%=name %>" class="form-control" placeholder="请输入老人姓名">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_name_edit" class="col-md-3 text-right">老人姓名:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_name_edit" name="userInfo.name" class="form-control" placeholder="请输入老人姓名">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_userPhoto_edit" class="col-md-3 text-right">老人照片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_xqah_edit" class="col-md-3 text-right">兴趣爱好:</label>
		  	 <div class="col-md-9">
			    <textarea id="userInfo_xqah_edit" name="userInfo.xqah" rows="8" class="form-control" placeholder="请输入兴趣爱好"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_xqah_edit").val(userInfo.xqah);
