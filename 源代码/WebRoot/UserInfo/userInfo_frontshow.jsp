...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>UserInfo/frontlist">老人信息</a></li>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">老人姓名:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">兴趣爱好:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getXqah()%></div>
	</div>
	<div class="row bottom15"> 
