...
<jsp:include page="check_worker_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	<div class="logo">社区养老服务网系统后台管理</div>
	<div class="logout">您好，<%=session.getAttribute("worker")%> | <a href="logout">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_worker.js"></script>
