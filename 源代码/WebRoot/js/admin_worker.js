		       ...
		       text: "健康信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Health/health_add.jsp"
			    	   	},
			    		{
			    	   		text: "老人健康信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Health/health_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "值班管理",
			    	   ...
			    	   [ 
			    		{
			    	   		...
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Zhiban/zhiban_workerQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "上门诊断管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Zhenduan/zhenduan_workerAdd.jsp"
			    	   	},
			    		{
			    	   		text: "我的上门诊断管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Zhenduan/zhenduan_workerQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "志愿者管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-edit",
			    		    url: "Worker/worker_selfModify.jsp"
			    	   	}
			    	   ]
			}],
