...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">社区养老服务网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>UserInfo/frontlist">老人查询</a></li>
                <li><a href="<%=basePath %>Worker/frontlist">医疗工作者</a></li>
                <li><a href="<%=basePath %>Health/frontlist">健康记录</a></li>
                <li><a href="<%=basePath %>Zhiban/frontlist">值班查询</a></li>
                <li><a href="<%=basePath %>Zhenduan/frontlist">上门诊断</a></li>
                <li><a href="<%=basePath %>Zyz/frontlist">志愿者风采</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Health/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我家健康记录查询</a></li>
                        <li><a href="<%=basePath %>Zhenduan/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我家老人诊断记录</a></li>
